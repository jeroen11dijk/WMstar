...
benchmarker = MapfwBenchmarker("42cf6ce8D2A5B954", 17, "M*", "Cpp optimized but bad heuristic", True)
for problem in benchmarker:
    ...
    print(Mstar_cpp(problem.grid, problem.starts, cpp_waypoints, problem.goals).solve()[0])
