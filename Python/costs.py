...
Mstar_inflated_cost = [36, 48, 75, 26, 119, 27, 205, 821, 1741, 1598, 100, 117, 52, 34, 70, 70, 53, 51, 2921, 43,
                       np.nan, 115, 144, 1551, 120, 169, 333, 28, 39, 850, 65, 1197, 14, 96, 94]
...
MLA_cost = [36, 49, 87, np.nan, 131, 27, 347, 1149, 2264, 2624, 102, 121, 63, 36, 88, 98, 56, 56, 4410, np.nan, 533,
            182, 286, 2023, 215, 193, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan]
