...
if __name__ == '__main__':
    benchmarker = MapfwBenchmarker("42cf6ce8D2A5B954", [85, 86, 87], "M* Inflated", "Python", False, solver=solve,
                                   cores=-1)
    benchmarker.run()

# benchmarker = MapfwBenchmarker("42cf6ce8D2A5B954", 22, "M*", "Python", True, solver=solve, cores=-1)
